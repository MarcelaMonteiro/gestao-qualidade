				...
				<Modal title="Editar usuário" onClose={close}>
					<form onSubmit={handleSubmit(onSubmit)} noValidate className="flex flex-col gap-4">
						<div className="flex flex-col gap-1.5">
							<label htmlFor={`edit-name-${userId}`} className="text-sm font-medium text-text">
								Nome
							</label>
							<input
								id={`edit-name-${userId}`}
						...
						<div className="flex flex-col gap-1.5">
							<label htmlFor={`edit-email-${userId}`} className="text-sm font-medium text-text">
								E-mail
							</label>
							<input
						...
						<div className="flex flex-col gap-1.5">
							<label htmlFor={`edit-role-${userId}`} className="text-sm font-medium text-text">
								Perfil
							</label>
							<select
								id={`edit-role-${userId}`}
